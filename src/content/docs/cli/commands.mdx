...
- `--noMetadata` - Disable metadata modification. This will skip metadata modification process of the executable.
...
## `astra init`
Create `astra.config.js` file in the current directory.
